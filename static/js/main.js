...
function adjustHeaderOnScroll() {
  ...
  const searchBar = document.querySelector(".projekt-search-outer");
...
function toggleConfirmPassword() {
  ...
  var confirmPasswordIcon = document.getElementById(
...
function toggleSharePopup() {
  ...
  sharePopup.style.display =
    sharePopup.style.display === "none" || sharePopup.style.display === ""
      ? "block"
      : "none";
}
